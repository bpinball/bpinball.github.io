JSSpeccy.UI = function(opts) {
	...
	var infiniteLives = document.getElementById('infinite-lives');
	infiniteLives.checked = false;
	infiniteLives.onchange = () => {
		if (infiniteLives.checked) {
			controller.writeMemory(26948, 182);
		} else {
			controller.writeMemory(26948, 221);
		}
	};
